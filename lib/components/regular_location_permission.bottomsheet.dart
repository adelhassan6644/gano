  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      children: [
        ...
        const Text(
            "This app collects location data to enable system search for assignable order within your location and also allow customer track your location when deganoring their order."),
