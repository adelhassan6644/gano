import 'package:gano/features/setting/model/setting_model.dart';
import 'package:dartz/dartz.dart';
import 'package:dio/dio.dart';
import 'package:flutter/material.dart';
import 'package:gano/features/setting/model/contact_model.dart';
...
class ConfigProvider extends ChangeNotifier {
  ...
  getContact() async {
    try {
      isGetting = true;
      notifyListeners();
      Either<ServerFailure, Response> response = await repo.getAbutUs();
      response.fold((l) {
        CustomSnackBar.showSnackBar(
            notification: AppNotification(
                message: ApiErrorHandler.getMessage(l),
